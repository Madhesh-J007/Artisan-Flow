...
const artisans = JSON.parse(readFileSync(join(__dirname, "../data/artisanProfiles.json")));
const opportunities = JSON.parse(readFileSync(join(__dirname, "../data/opportunities.json")));
